...
class CombainedTest {
    ...
    void Should_AddUser_AddTask_GetTask() throws IOException, InterruptedException {
        ...
        assertThat(addUserResponse.code).isEqualTo(HttpCode.CREATED_201.getResponseCode());

        TestTaskResponse addTaskResponse = addTask(token, "Kuba musi buy cos", "2021-06-30");
        assertThat(addTaskResponse.code).isEqualTo(HttpCode.CREATED_201.getResponseCode());

        TestTaskResponse getTaskResponse = getTask(token, addTaskResponse.taskEntity.getId().toString());
        assertThat(getTaskResponse.code).isEqualTo(HttpCode.OK_200.getResponseCode());
    ...
    void Should_AddTwoUsers_AddTask_RandomUser401() throws IOException, InterruptedException {
        ...
        assertThat(get2TaskResponse.code).isEqualTo(HttpCode.UNAUTHORIZED_401.getResponseCode());
    }
    ...
    void Should_AddUser_Tasks404() throws IOException, InterruptedException {
        ...
        assertThat(getTaskResponse.code).isEqualTo(HttpCode.NOT_FOUND_404.getResponseCode());
    ...
    void Should_AddTwoUsers_AddTask_SecondUser403() throws IOException, InterruptedException {
        ...
        String token = createToken(login, password);
        String token2 = createToken(login2, password2);
        ...
        assertThat(addUser2Response.code).isEqualTo(HttpCode.CREATED_201.getResponseCode());
        ...
        assertThat(get3TaskResponse.code).isEqualTo(HttpCode.FORBIDDEN_403.getResponseCode());
    }
    ...
    void Multiple_Testing_Adding_Task() throws IOException, InterruptedException {
        ...
        assertThat(addTaskResponse.code).isEqualTo(HttpCode.BAD_REQUEST_400.getResponseCode());
        ...
        assertThat(addTaskResponse.code).isEqualTo(HttpCode.UNAUTHORIZED_401.getResponseCode());
    }
    ...
    void Should_AddUser_AddTask_DeleteTask_NotGetTask() throws IOException, InterruptedException {
        ...
        assertThat(resposne.code).isEqualTo(HttpCode.CREATED_201.getResponseCode());
        ...
        assertThat(deleteTaskResponse.code).isEqualTo(HttpCode.OK_200.getResponseCode());

        TestTaskResponse notGetTaskResponse = getTask(token, addTaskResponse.taskEntity.getId().toString());
        assertThat(notGetTaskResponse.code).isEqualTo(HttpCode.NOT_FOUND_404.getResponseCode());
    ...
    void Should_AddTwoUser_AddTask_PutTask() throws IOException, InterruptedException {
        ...
        assertThat(getTaskResponse.code).isEqualTo(HttpCode.FORBIDDEN_403.getResponseCode());
    }
